...
exports.removeInstitution = exports.getInstitutions = exports.addInstitution = void 0;
var institution_1 = require("../models/institution");
var mongoose = require('mongoose');
function addInstitution(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var institution, newInstitution, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    institution = req.body;
                    console.log(institution);
                    newInstitution = new institution_1["default"]();
...
function getInstitutions(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, institution_1["default"].find()];
                case 1:
...
;
function removeInstitution(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    institution = req.body;
                    return [4 /*yield*/, institution_1["default"].findOneAndRemove(institution)];
                case 1:
                    result = _a.sent();
                    res.status(200).send(result);
                    return [2 /*return*/];
